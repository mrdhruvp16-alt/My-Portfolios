...
// Videos shown per carousel "page" — 2 on phones/tablets, 3 on laptops and up.
// Threshold is intentionally lower than a typical laptop's physical width
// (not 960) because Windows display scaling (125%/150%, common on laptops)
// makes window.innerWidth read smaller than the real screen — a full-size
// laptop can otherwise get miscounted as "mobile" and lose the 3rd column.
function getPerPage() {
